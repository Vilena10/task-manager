...
console.log(link);
/*3. Выбрать несколько эллементов по селектору */
const paragraphs = document.querySelectorAll("p");
console.log(paragraphs)

/*4. Выбрать один или несколько внутри другого эллемента */
...
h1.textContent = "Privet!";
h1.innerText = "Заголовок <img src='img/1.jpg' alt='logo'> ";
h1.innerHTML = "Заголовок <img src='img/1.jpg' alt='logo'> ";
...
newImg.setAttribute("src", "img/picture.jpg");
